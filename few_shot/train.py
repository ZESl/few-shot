...
def gradient_step(model: Module, optimiser, loss_fn: Callable, x: torch.Tensor, y: torch.Tensor, **kwargs):
...
def fit(model: Module, optimiser, loss_fn: Callable, epochs: int, dataloader: DataLoader,
