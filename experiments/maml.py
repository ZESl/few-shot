...
from few_shot.datasets import OmniglotDataset, MiniImageNet, MotionDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inner-lr', default=0.4, type=float)      # 内层support set的学习率
    parser.add_argument('--meta-lr', default=0.001, type=float)     # 外层query set任务的学习率
